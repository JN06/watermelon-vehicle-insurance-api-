...
@Entity 
@Table(name = "diesel_pricing")
public class DieselPricing {


	public DieselPricing() {
	
	}
	
	public DieselPricing(int id, String car_value_range, double Avg_dealer_2yr_30000kms, 
